...
public class SkillUseSerializer : Serializer {

	public bool Serialize(SkillUseData data)
	{
		bool ret = true;
	...
	public bool Deserialize(ref SkillUseData element)
	{
		if (GetDataSize() == 0)
		{
			// 데이터가 설정되지 않았다.
